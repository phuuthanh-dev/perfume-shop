...
<!-- Sidebar -->
<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white" style="padding: 0px; width: 270px">
    <div class="position-sticky">
        <div class="list-group list-group-flush mx-3 mt-4">
            <div class="footer_logo" style="text-align: center">
                <a href="home"><img src="images/logo.png" alt="Logo" style="height: 60px"></a>
            </div>
            ...
            <a href="doanhThuTheoThu" class="list-group-item list-group-item-action" style="margin-top: 10px">
            ...
            <a href="doanhThuTheoThang" class="list-group-item list-group-item-action" style="margin-top: 10px">
            ...
            <a href="hoaDon" class="list-group-item list-group-item-action" style="margin-top: 10px">
            ...
            <a href="managerSupplier" class="list-group-item list-group-item-action py-2 ripple" style="margin-top: 10px">
            </a>
        </div>
    </div>
</nav>